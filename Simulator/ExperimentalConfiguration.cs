...
namespace Simulator
{
    public class ExperimentalConfiguration
    {
        ...
        public ulong TotalLoginAttemptsToIssue = 20;
        public ulong RecordUnitAttempts = 10;
        ...
        public readonly BenignUserAccountGroup[] BenignUserGroups = new BenignUserAccountGroup[]
        {
            ...
            new BenignUserAccountGroup() {GroupSize = 200, LoginsPerYear = DaysPerYear*5},
            // Group 1 logs in once per day
            new BenignUserAccountGroup() {GroupSize = 200, LoginsPerYear = DaysPerYear},
            // Group 2 logs in once per week
            new BenignUserAccountGroup() {GroupSize = 200, LoginsPerYear = WeeksPerYear},
            // Group 3 logs in once per month
            new BenignUserAccountGroup() {GroupSize = 200, LoginsPerYear = MonthsPerYear},
            // Group 4 logs in once per year
            new BenignUserAccountGroup() {GroupSize = 200, LoginsPerYear = 1}
        };
    }
}
